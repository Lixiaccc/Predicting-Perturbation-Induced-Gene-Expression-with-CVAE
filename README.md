...
The notebooks were run in Google Colab with Google Drive mounted. GPU is not required for the OT analysis, but some moscot / JAX operations may run faster with hardware acceleration.
